...
public class CartService : ICartService
{
    ...
    {
        var cart = await _cartRepository.GetCartByCustomerIdNoTrackingAsync(customerId, cancellationToken);
        return cart?.ToDto();
    }
    ...
    public async Task<CartDto> AddToCartAsync(Guid customerId, AddToCartDto request, CancellationToken cancellationToken = default)
    {
        ...
        var updatedCart = await _cartRepository.GetCartByCustomerIdNoTrackingAsync(customerId, cancellationToken);
